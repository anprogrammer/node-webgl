...
module.exports = function () {
    ...
    platform = {
        ...
        createElement: function (name, width, height, fs) {
            if (name.indexOf('canvas') >= 0) {
                this.createWindow(width || 800, height || 800, fs || false);
                this.canvas = this;
                WebGL.canvas = this;
                return this;
            }
        ...
        createWindow: function (width, height, fs) {
    ...
    platform.enableHMD = function() {
        return GLFW.EnableHMDRendering(currentWindow);
    };
    ...
    platform.endVREye = function(n) {
        return GLFW.EndVREye(n);
    };
